...
export default class WalletManagerEvm extends WalletManager {
     ...
     */
    getAccount(indexOrSignerName?: number, options?: Object): Promise<WalletAccountEvm>;
    /**
     ...
     */
    getAccount(indexOrSignerName: string): Promise<WalletAccountEvm>;
    /**
     ...
     * @throws {SignerError} If the signer doesn't support account derivation.
     */
    getAccountByPath(path: string, options?: Object): Promise<WalletAccountEvm>;
    /**
